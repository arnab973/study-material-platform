...
const PlantPathologyNotes = () => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await fetch("/api/list-files?grade=Agriculture&subject=plant-pathology&type=notes");
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        Agriculture <span className="text-primary">Plant Pathology</span> Notes
      </h1>
...
export default PlantPathologyNotes;

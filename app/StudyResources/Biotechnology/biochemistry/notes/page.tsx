...
const BiochemistryNotes = () => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await fetch("/api/list-files?grade=Biotechnology&subject=biochemistry&type=notes");
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        Biotechnology <span className="text-primary">Biochemistry</span> Notes
      </h1>
...
export default BiochemistryNotes;

...
const OperatingSystemsNotes = () => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await fetch("/api/list-files?grade=CSE-CS&subject=operating-systems&type=notes");
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        CSE CS <span className="text-primary">Operating Systems</span> Notes
      </h1>

...
const CSEDSStatisticsNotes = () => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await fetch("/api/list-files?grade=CSE-DS&subject=statistics&type=notes");
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        CSE DS <span className="text-primary">Statistics</span> Notes
      </h1>
...
export default CSEDSStatisticsNotes;

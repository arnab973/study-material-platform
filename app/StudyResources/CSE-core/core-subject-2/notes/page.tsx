...
const CSECoreCoreSubject2Notes = () => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await fetch("/api/list-files?grade=CSE-core&subject=core-subject-2&type=notes");
  ...
  return (
    <main className="p-6 min-h-screen">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        CSE Core <span className="text-primary">Core Subject 2</span> Notes
      </h1>
...
export default CSECoreCoreSubject2Notes;

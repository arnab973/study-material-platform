    ...
    const fetchFiles = async () => {
      try {
        const response = await fetch(
          "/api/list-files?grade=Agriculture&subject=books&type=books"
        );
  ...
  return (
    <main className="p-6 min-h-screen text-white">
      ...
      <h1 className="text-2xl sm:text-4xl font-bold mb-6 mt-6 text-white text-center">
        Agriculture <span className="text-primary">Books</span>
      </h1>
...
export default AgricultureBooksList;
